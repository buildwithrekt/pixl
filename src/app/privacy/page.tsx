...
export const metadata: Metadata = {
  ...
  description: "BLOKR privacy policy and data handling practices.",
}
    ...
    <main className="min-h-screen bg-black">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            <h2 className="font-display text-xl text-white mb-4">1. Introduction</h2>
            <p className="text-gray-400 leading-relaxed">
              BLOKR is committed to protecting your privacy. This policy explains how we collect,
          ...
          <section>
            <h2 className="font-display text-xl text-white mb-4">2. Information We Collect</h2>

            <h3 className="font-display text-lg text-white mb-3 mt-6">Wallet Information</h3>
            ...
            <h3 className="font-display text-lg text-white mb-3">Transaction Data</h3>
            <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <h3 className="font-display text-lg text-white mb-3">Uploaded Content</h3>
            <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <h3 className="font-display text-lg text-white mb-3">Usage Data</h3>
            <p className="text-gray-400 leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-xl text-white mb-4">3. How We Use Information</h2>
          ...
          <section>
            <h2 className="font-display text-xl text-white mb-4">4. Information Sharing</h2>
            <p className="text-gray-400 leading-relaxed mb-4">
              We do not sell your personal information. Information may be shared in these cases:
            </p>
            <ul className="list-disc list-inside text-gray-400 space-y-2">
              <li><strong className="text-white">Public blockchain:</strong> Transaction data is inherently public on{" "}
                <span className="font-mono text-lime">Robinhood Chain</span>
              </li>
              <li><strong className="text-white">Canvas display:</strong> Your zones and images are publicly visible</li>
              <li><strong className="text-white">Service providers:</strong> We use Vercel for hosting and image storage</li>
              <li><strong className="text-white">Legal requirements:</strong> When required by law or to protect rights</li>
            </ul>
          </section>

          <section>
            <h2 className="font-display text-xl text-white mb-4">5. Data Storage</h2>
            <p className="text-gray-400 leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-xl text-white mb-4">7. Cookies</h2>
            <p className="text-gray-400 leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-xl text-white mb-4">8. Security</h2>
            <p className="text-gray-400 leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-xl text-white mb-4">9. Children&apos;s Privacy</h2>
            <p className="text-gray-400 leading-relaxed">
              BLOKR is not intended for users under 18. We do not knowingly collect information
              from minors. If you believe a minor has provided us information, please contact us.
            </p>
          </section>

          <section>
            <h2 className="font-display text-xl text-white mb-4">10. Changes to Policy</h2>
            <p className="text-gray-400 leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-xl text-white mb-4">11. Contact</h2>
            <p className="text-gray-400 leading-relaxed">
